import { RejectUniversityUseCasePort } from '../ports/inputs/AuthUseCasesPort';
...
export class RejectUniversityUseCase implements RejectUniversityUseCasePort {
  ...
  async execute(userId: string): Promise<void> {
    ...
    await this.userRepository.updateVerificationStatus(userId, 'REJECTED', false);
  }
}
